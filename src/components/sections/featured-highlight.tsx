...
import type { Project, Category, ProjectImage, HomeSection } from "@prisma/client";
...
export function FeaturedHighlight({
  ...
  const badgeText = config?.eyebrow ?? "Featured";
  const ctaLabel = config?.ctaLabel ?? "View case study";
